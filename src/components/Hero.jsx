...
<div className='m-2'>
  ...
  <hr className="border-gray-800"/>
        ...
        <div>
            ...
            <div className="space-y-1 justify-center w-full mt-3 lg:ml-3">
                <div>
                ...
                <div className="text-gray-600 flex">
                    <span className="flex lg:mr-2">
                    <img className=' rounded-full w-3 h-3 mt-1 lg:w-5 lg:mr-1' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJ63xmdyqloMwBqqPbu6O9Fq1CX-Tdjq8dww&s" alt="" />
