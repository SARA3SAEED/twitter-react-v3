    ...
    <>
      <div className="flex">
        ...
        <div className="flex-1 px-4 py-2 m-2">
          <Link to="/profile" className="text-2xl font-medium rounded-full text-white hover:bg-blue-800 hover:text-blue-300 float-right">
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-2 pt-2 mt-2">
          <textarea className="bg-transparent text-gray-400 font-medium text-lg w-full" rows="2" placeholder="What's happening?"></textarea>
        </div>
      </div>
