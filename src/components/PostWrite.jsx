...
export default function PostWrite() {
  return (
    <>
    <div class="max-w-[40%] bg-black rounded-2xl">
      <div class="flex ">
                    <div class="m-2 mt-5 w-10 py-1">
                    ...
                    <div class="flex-1 mt-5 mr-2  px-2 pt-2 mt-2">
                        <textarea class=" bg-transparent h-[150px] text-gray-400 font-medium text-lg w-full" rows="2" cols="50" placeholder="What's happening?"></textarea>
                    </div>                    
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="w-64 px-2">
                        ...
                        <div class="flex items-center">
                            <div class="flex-1 text-center px-1 py-1 mx-2">
                            ...
                            <div class="flex-1 text-center py-2 mx-2">
                                <a href="#" class="mt-1 group flex items-center text-blue-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-800 hover:text-blue-300">
                    ...
                    <div class="flex-1">
                        <button class="bg-blue-400 mt-3 hover:bg-blue-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                            Post
                          </button>
                    </div>
                </div>
